...
import { IDropDown, ISubmenuItems } from "@/app/lib/types/typed";
					...
					<div className="flex flex-col w-full h-auto mt-10">
						...
						{item &&
							item.subtitles.map((sub) => (
								<span className="relative cursor-pointer text-md py-2 hover:text-red-800 transition-color duration-300">
									{sub}
								</span>
							))}
					</div>
